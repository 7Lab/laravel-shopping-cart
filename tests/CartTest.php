...
class CartTest extends TestCase
{
    ...
    public function testCartCanAdd()
    {
        ...
        $this->assertTrue($this->cart->content()->pluck('id')->contains('293ad'));
    }
    ...
    public function testCartCanAddWithNumericId()
    {
        ...
        $this->assertTrue($this->cart->content()->pluck('id')->contains(12345));
    ...
    public function testCartCanAddBatch()
    {
        ...
        $this->assertTrue($this->cart->content()->pluck('id')->contains('293ad'));
        $this->assertTrue($this->cart->content()->pluck('id')->contains('4832k'));
    }
    ...
    public function testCartCanAssociateWithModel()
    {
        ...
        $this->assertAttributeEquals('TestProduct', 'associatedModel', $this->cart);
    }
    ...
    public function testCartCanAssociateWithNamespacedModel()
    {
        ...
        $this->assertAttributeEquals('TestProduct', 'associatedModel', $this->cart);
        $this->assertAttributeEquals('Acme\Test\Models', 'associatedModelNamespace', $this->cart);
    }
